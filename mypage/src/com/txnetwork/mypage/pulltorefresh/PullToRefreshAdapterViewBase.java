...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements OnScrollListener {
    ...
    private IndicatorLayout mIndicatorIvTop = new IndicatorLayout(getContext(), Mode.PULL_FROM_START);
    ...
    protected void handleStyledAttributes(TypedArray a) {
        ...
        mShowIndicator = a.getBoolean(R.styleable.PullToRefreshGridView_ptrShowIndicator, !isPullToRefreshOverScrollEnabled());
    }
