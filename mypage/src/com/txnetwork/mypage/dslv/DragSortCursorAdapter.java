 ...
 * to {@link com.jit.demo.dslv.DragSortListView#setAdapter(ListAdapter)} and, since
 * this class implements the {@link com.jit.demo.dslv.DragSortListView.DragSortListener}
...
public abstract class DragSortCursorAdapter extends CursorAdapter implements DragSortListView.DragSortListener {
     ...
     *
     * @see com.jit.demo.dslv.DragSortListView.DropListener#drop(int, int)
     */
    @Override
     ...
     * the current mapping with {@link getCursorPositions()}.
     *
     * @see com.jit.demo.dslv.DragSortListView.RemoveListener#remove(int)
     */
    @Override
