...
public class Crop {
     ...
     */
    public Crop(Uri source, String picPath, String picid) {
        cropIntent = new Intent();
        cropIntent.putExtra("picPath", picPath);
        cropIntent.putExtra("picid", picid);
    ...
    public Intent getIntent(Context context) {
        cropIntent.setFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
